    ...
    try {
      const itemsHtml = orderItems.map(item => `
        <tr>
          ...
          <td style="padding: 8px; border-bottom: 1px solid #f0f0f0; text-align: right;">P${(item.price * item.qty).toFixed(2)}</td>
        </tr>
      `).join("");
          ...
          <table style="width: 100%; border-collapse: collapse;">
            ...
            <tfoot>
              <tr>
                ...
                <td style="padding: 12px 8px; font-weight: bold; color: #f97316; text-align: right; font-size: 18px;">P${total.toFixed(2)}</td>
              </tr>
            </tfoot>
          </table>
